...
/alias glogr damlog reset group%; bleedlog reset group%; heallog reset group%;hitlog reset group%;explog reset group
/alias gr group %{*}
/alias m group priest
/alias hl hitlog show group
/alias od open door %{*}
/alias of order followers %*
/alias rec order followers RECALL
/alias weap /w %{*}
...
/if (magician|warlock>0) \
    ...
    /alias t cast 'Teleport Without Error'%;\
/elseif (priest>0) \
    /alias di cast 'detect invis'%;\
    /alias t cast 'word of recall'%;\
/elseif (nightblade>0) \
    /alias blur cast 'Blur'%;\
    /alias di cast 'detect invis'%;\
...
/if (magician>0) \
    ...
    /alias cl cast 'Cloudkill'%;\
    /alias ch cast 'Charm Person' %%{*}%;\
    /alias chl cast 'Chain Lightning'%;\
...
/if (nightblade>0) \
    ...
    /if (nightblade=2) \
        ...
        /alias stun cast 'Powerword Stun' %%{*}%;\
    /endif%;\
/endif
